...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'light'){
			jQuery(".nav-header .logo-abbr").attr("src", "/ServerlessEngine/OpenAPIs/PaaS/ArtSpace/static/assets/resource/common/products/small_sign-v2.svg");
			jQuery(".nav-header .logo-compact").attr("src", "/ServerlessEngine/OpenAPIs/PaaS/ArtSpace/static/assets/resource/common/products/word_sign-v2.svg");
			jQuery(".nav-header .brand-title").attr("src", "/ServerlessEngine/OpenAPIs/PaaS/ArtSpace/static/assets/resource/common/products/word_sign-v2.svg");
			setCookie('logo_src', '/ServerlessEngine/OpenAPIs/PaaS/ArtSpace/static/assets/resource/common/products/small_sign-v2.svg');
			setCookie('logo_src2', '/ServerlessEngine/OpenAPIs/PaaS/ArtSpace/static/assets/resource/common/products/word_sign-v2.svg');
		} else {
			jQuery(".nav-header .logo-abbr").attr("src", "/ServerlessEngine/OpenAPIs/PaaS/ArtSpace/static/assets/resource/common/products/small_sign-v2.svg");
			jQuery(".nav-header .logo-compact").attr("src", "/ServerlessEngine/OpenAPIs/PaaS/ArtSpace/static/assets/resource/common/products/word_sign-v2.svg");
			jQuery(".nav-header .brand-title").attr("src", "/ServerlessEngine/OpenAPIs/PaaS/ArtSpace/static/assets/resource/common/products/word_sign-v2.svg");
